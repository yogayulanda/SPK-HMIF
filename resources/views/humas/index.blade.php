                ...
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title">Humas</h3>
                            <p class="panel-subtitle">Kriteria Divisi Humas</p>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @if (auth()->user()->role =='admin' || auth()->user()->role == 'humas' )
                                        <td>
                                            <a href="/humas/{{$krt->id}}/edit" class="btn btn-edit"><i
                                                    class="fa fa-pencil"></i></a>
                                            <a href="#" class="btn btn-danger btn-delete delete"
                                                kriteria-id="{{$krt->id}}" nama-kriteria="{{$krt->nama_kriteria}}"><i
                                                    class="fa fa-trash"></i>
                                            </a>
                                        </td>
                                        @endif
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/humas/create" method="POST">
                            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title">Humas</h3>
                            <p class="panel-subtitle">Nilai Humas</p>
                            <div class="text-right">
                                <a href="/humas/hitungutility" class="btn btn-tombol">Nilai Utility</a>
                                <a href="/humas/smart" class="btn btn-delete">Perhitungan</a>
                            </div>
                        </div>
                        {{-- Isi Tabel Mahasiswa --}}
                        <div class="panel-body">
                            <table class="table table-hover" id="data">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($p->KriteriaHumas->sortBy('id'); as $n)
                                        <td>{{$n->pivot->nilai}}</td>
                                        @endforeach
                                    </tr>
                                    @endforeach
...
.then((willDelete) => {
    console.log(willDelete);
        if (willDelete) {
            window.location = "/humas/"+kriteria_id+"/delete"
        } 
});
});

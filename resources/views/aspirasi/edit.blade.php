                ...
                <div class="col-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Kriteria Divisi Aspirasi dan Advokasi</h3>
                        </div>
                        <div class="panel-body">
                            <form action="/aspirasi/{{$kriteria_aspirasi->id}}/update" method="POST">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <label for="example">Nama Kriteria</label>
                                    <input name="nama_kriteria" type="text" class="form-control" id="nama_mahasiswa"
                                        placeholder="Masukkan Nama" value="{{$kriteria_aspirasi->nama_kriteria}}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input name="bobot_kriteria" type="text" class="form-control" id="nim"
                                        ...
                                        value="{{$kriteria_aspirasi->bobot_kriteria}}">
                                </div>

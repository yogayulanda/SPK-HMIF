                ...
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title">Aspirasi</h3>
                            <p class="panel-subtitle">Kriteria Divisi Aspirasi</p>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @if (auth()->user()->role =='admin' || auth()->user()->role == 'aspirasi' )
                                        <td>
                                            <a href="/aspirasi/{{$krt->id}}/edit" class="btn btn-edit"><i
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title">Aspirasi</h3>
                            <p class="panel-subtitle">Nilai Aspirasi</p>
                            <div class="text-right">
                                <a href="/aspirasi/hitungutility" class="btn btn-tombol">Nilai Utility</a>
                                <a href="/aspirasi/smart" class="btn btn-danger btn-delete">Perhitungan</a>
                            </div>
                        </div>
                        {{-- Isi Tabel Mahasiswa --}}
                        <div class="panel-body">
                            <table class="table table-hover" id="data">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($p->KriteriaAspirasi->sortBy('id'); as $n)
                                        <td>{{$n->pivot->nilai}}</td>
                                        @endforeach
                                    </tr>
                                    @endforeach
...
.then((willDelete) => {
    console.log(willDelete);
        if (willDelete) {
            window.location = "/aspirasi/"+kriteria_id+"/delete"
        } 
});
});

                    ...
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            ...
                            <div class="text-right">
                                <a href="/aspirasi/smart" class="btn btn-delete">Hitung Perangkingan</a>
                                <a href="/aspirasi/" class="btn btn-tombol">Back</a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <table class="table table-hover" id="aspirasiutility">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
...
<script>
    ...
    $('#aspirasiutility').DataTable();         // Deklarasi Data Table
    });
</script>

                ...
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            ...
                            <p class="panel-subtitle">Kriteria Divisi Keorganisasian</p>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/keorganisasian/{{$krt->id}}/edit" class="btn btn-edit"><i
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/keorganisasian/create" method="POST">
                            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title">Keorganisasian</h3>
                            <p class="panel-subtitle">Nilai Keorganisasian</p>
                            <div class="text-right">
                                <a href="/keorganisasian/hitungutility" class="btn btn-tombol">Nilai Utility</a>
                                <a href="/keorganisasian/smart" class="btn btn-delete">Perhitungan</a>
                            </div>
                        </div>
                        {{-- Isi Tabel Mahasiswa --}}
                        <div class="panel-body">
                            <table class="table table-hover" id="data">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($p->KriteriaKeorganisasian->sortBy('id'); as $n)
                                        <td>{{$n->pivot->nilai}}</td>
                                        @endforeach
                                    </tr>
                                    @endforeach
...
.then((willDelete) => {
    console.log(willDelete);
        if (willDelete) {
            window.location = "/keorganisasian/"+kriteria_id+"/delete"
        } 
});
});

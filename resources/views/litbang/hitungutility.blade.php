                    ...
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            ...
                            <div class="text-right">
                                <a href="/litbang/smart" class="btn btn-delete">Hitung Perangkingan</a>
                                <a href="/litbang/" class="btn btn-tombol">Back</a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <table class="table table-hover" id="litbangutility">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
...
<script>
    ...
    $('#litbangutility').DataTable();         // Deklarasi Data Table
    });
</script>
